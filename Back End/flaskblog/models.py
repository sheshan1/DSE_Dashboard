...
class RunningTimeSchema(ma.Schema):
    class Meta:
        fields = ('id', 'trip_id', 'deviceid', 'direction', 'segment', 'run_time_in_seconds',
...
class RunningTime(db.Model):
    ...
    segment = db.Column(db.Integer)
    run_time_in_seconds = db.Column(db.Integer)
...
class DwellTimeSchema(ma.Schema):
    class Meta:
       ...
       'conditions', 'rt(n-1)', 'stop_type', 'dwell_time_in_seconds', 'year',
...
class DwellTime(db.Model):
    ...
    dwell_time_in_seconds = db.Column(db.Integer)
    day_of_week = db.Column(db.Integer)
    time_of_day = db.Column(db.Float)
    Sunday_holiday = db.Column(db.Integer)
    saturday = db.Column(db.Integer)
    ...
    def __init__(self, trip_id, deviceid, direction, bus_stop, dwell_time_in_seconds, day_of_week, time_of_day, Sunday_holiday, saturday, weekday_end, week_no, dt_w_1, dt_w_2, dt_w_3, dt_t_1, dt_t_2, dt_n_1, dt_n_2, dt_n_3, day, month, temp, precip, windspeed, conditions, rt_n_1, stop_type, year, arrival_hour, arrival_min, arrival_sec):
        self.trip_id = trip_id
        self.deviceid = deviceid
        self.direction = direction
        self.bus_stop = bus_stop
        self.dwell_time_in_seconds = dwell_time_in_seconds
        self.day_of_week = day_of_week
        self.time_of_day = time_of_day
        self.Sunday_holiday = Sunday_holiday
        self.saturday = saturday
